...
Blockly.Msg.CONTROLS_IF_MSG_ELSE = "そうでないとき、";
Blockly.Msg.CONTROLS_IF_MSG_ELSEIF = "そうでないとき、もし";
...
Blockly.Msg.CONTROLS_REPEAT_INPUT_DO = "する";
Blockly.Msg.CONTROLS_REPEAT_TITLE = "%1 回、くり返す";
...
Blockly.Msg.LISTS_GET_INDEX_FROM_END = "おわりから #";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND = "両方の入力がおんなじ場合はtrue を返します。";
...
Blockly.Msg.MATH_IS_EVEN = "は2で割り切れる";
Blockly.Msg.MATH_IS_NEGATIVE = "負の値";
Blockly.Msg.MATH_IS_ODD = "は2で割り切れない";
Blockly.Msg.MATH_IS_POSITIVE = "正の値";
Blockly.Msg.MATH_IS_PRIME = "は素数";
Blockly.Msg.MATH_IS_TOOLTIP = "数字が、偶数、奇数、素数、整数、正数、負数、またはそれが特定の数で割り切れる場合かどうかを確認してください。どの制限が一つでも本当でしたら true をかえしてください、そうでない場合はfalseを返してください。";
